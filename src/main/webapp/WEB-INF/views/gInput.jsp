...
<!-- unity js -->
<script src="<c:url value="/resources/ijs/UnityProgress.js"/>"></script>
<script src="<c:url value="/resources/ijs/UnityLoader.js"/>"></script>
<!-- Input game 불러오기 -->
<script>
	var gameInstance = UnityLoader.instantiate("gameContainer",
			"/resources/build/InputWebGL.json", {
				...
				<div class="sidebar-sticky" style="padding: 10px 0 0 10px;">
					<ul class="nav flex-column"
						...
						<li class="nav-item"><a class="nav-link" href="<c:url value="gInput"/>"
							style="color: #FFFFFF; font-weight: 900; font-size: large;"> <span data-feather="file"></span>
								입력문
						</a></li>
