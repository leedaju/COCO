...
<!-- unity js -->
<script src="<c:url value="/resources/ljs/UnityProgress.js"/>"></script>
<script src="<c:url value="/resources/ljs/UnityLoader.js"/>"></script>
<!-- 반복문 game 불러오기 -->
<script>
	var gameInstance = UnityLoader.instantiate("gameContainer",
			"/resources/build/LoopWebGL.json", {
				...
				<div class="sidebar-sticky" style="padding: 10px 0 0 10px;">
					<ul class="nav flex-column"
						...
						<li class="nav-item"><a class="nav-link" href="<c:url value="gLoop"/>"
							style="color: #FFFFFF; font-weight: 900; font-size: large;"> <span data-feather="users"></span>
								반복문
						</a></li>
