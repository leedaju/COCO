...
<!-- unity js -->
<script src="<c:url value="/resources/pjs/UnityProgress.js"/>"></script>
<script src="<c:url value="/resources/pjs/UnityLoader.js"/>"></script>
<!-- 출력문 game 불러오기 -->
<script>
	var gameInstance = UnityLoader.instantiate("gameContainer",
			"/resources/build/printWebGL.json", {
		...
		<nav class="navbar navbar-expand-md navbar-dark fixed-top" style="background-color: #001d2d;">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active">
						<a class="nav-link" href="<c:url value="grammar"/>" style="font-weight: 900;"> Game 
							<span class="sr-only">(current)</span>
						</a>
					</li>
				</ul>
				...
				<div class="sidebar-sticky" style="padding: 10px 0 0 10px;">
					<ul class="nav flex-column"
						...
						<li class="nav-item" style="font-weight: 900; font-size: large;"> <a class="nav-link active" href="<c:url value="grammar"/>" style="color: #FFFFFF;"> 
							<span data-feather="home"></span> Grammar <span class="sr-only">(current)</span>
						</a></li>
						<li class="nav-item"><a class="nav-link active" href="<c:url value="gPrint"/>"
							style="color: #FFFFFF; font-weight: 900; font-size: large;"> <span data-feather="home"> </span>
