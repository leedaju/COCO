...
<!-- unity js -->
<script src="<c:url value="/resources/cjs/UnityProgress.js"/>"></script>
<script src="<c:url value="/resources/cjs/UnityLoader.js"/>"></script>
<!-- 조건문 game 불러오기 -->
<script>
	var gameInstance = UnityLoader.instantiate("gameContainer",
			"/resources/build/ConditionWebGL.json", {
				...
				<div class="sidebar-sticky" style="padding: 10px 0 0 10px;">
					<ul class="nav flex-column"
						...
						<li class="nav-item"><a class="nav-link" href="<c:url value="gCond"/>"
							style="color: #FFFFFF; font-weight: 900; font-size: large;"> <span data-feather="shopping-cart"></span>
								조건문
						</a></li>
